...
contract StrategyWKAI is StratManager, FeeManager, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wkai = address(0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d);
    address constant public xtoken = address(0xD675fF2B0ff139E14F86D87b7a6049ca7C66d76e); // DFL
    address constant public want = address(0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d); // WKAI

    // Third party contracts
    address constant public masterchef = address(0x0245a1f57Ee84b55Cf489Eb5F3d27355014e57f8); // Defily's masterchef
    ...
    constructor(
        ...
        address _strategist,
        address _sleepEarnFeeRecipient
    ) StratManager(_keeper, _strategist, _unirouter, _sleepEarnFeeRecipient) public {
        _giveAllowances();
    }
    ...
    // Swap all token to wkai
    function swapToWkai() internal {
        uint256 xtokenBal = IERC20(xtoken).balanceOf(address(this));
        IKAIDexRouter(unirouter).swapExactTokensForTokens(xtokenBal, 0, xtokenTowkaiRoute, address(this), now);
    }
