...
contract StrategyKaidexAmmLP is StratManager, FeeManager, GasThrottler {
    ...
    // Routes
    address[] public kdxTowkaiRoute = [kdx, wkai];
    address[] public kdxToLp0Route;
    address[] public kdxToLp1Route;
    ...
    {
        want = _want;
        lpToken0 = IKaidexSwapPair(want).token0();
        lpToken1 = IKaidexSwapPair(want).token1();
        poolId = _poolId;

        if (lpToken0 == wkai) {
            kdxToLp0Route = [kdx, wkai];
        } else if (lpToken0 != kdx) {
            kdxToLp0Route = [kdx, wkai, lpToken0];
        }

        if (lpToken1 == wkai) {
            kdxToLp1Route = [kdx, wkai];
